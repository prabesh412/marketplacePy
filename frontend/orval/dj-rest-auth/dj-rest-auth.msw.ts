...
export const getDjRestAuthOtpCreateMock = () => ({phone_number: faker.random.word(), otp: faker.random.word()})
...
export const getDjRestAuthRegisterCreateMock = () => ({username: faker.random.word(), name: faker.helpers.arrayElement([faker.random.word(), undefined]), image: faker.helpers.arrayElement([faker.internet.url(), undefined])})

export const getDjRestAuthUserRetrieveMock = () => ({pk: faker.datatype.number({min: undefined, max: undefined}), username: faker.random.word(), email: faker.internet.email(), first_name: faker.random.word(), last_name: faker.random.word()})

export const getDjRestAuthUserUpdateMock = () => ({pk: faker.datatype.number({min: undefined, max: undefined}), username: faker.random.word(), email: faker.internet.email(), first_name: faker.random.word(), last_name: faker.random.word()})

export const getDjRestAuthUserPartialUpdateMock = () => ({pk: faker.datatype.number({min: undefined, max: undefined}), username: faker.random.word(), email: faker.internet.email(), first_name: faker.random.word(), last_name: faker.random.word()})
